...
For further information please refer to the [technical documentation](https://github.com/eclipse-tractusx/portal-assets/tree/v1.3.0-RC1/developer/Technical%20Documentation).
...
| frontend.portal.image.portaltag | string | `"v1.3.0-RC1"` |  |
...
| frontend.assets.image.assetstag | string | `"v1.3.0-RC1"` |  |
...
| backend.registration.image.registrationservicetag | string | `"v1.3.0-RC1"` |  |
...
| backend.administration.image.administrationservicetag | string | `"v1.3.0-RC1"` |  |
...
| backend.provisioning.service.image.provisioningservicetag | string | `"v1.3.0-RC1"` |  |
...
| backend.appmarketplace.image.appmarketplaceservicetag | string | `"v1.3.0-RC1"` |  |
...
| backend.portalmigrations.image.portalmigrationstag | string | `"v1.3.0-RC1"` |  |
...
| backend.portalmaintenance.image.portalmaintenancetag | string | `"v1.3.0-RC1"` |  |
...
| backend.notification.image.notificationservicetag | string | `"v1.3.0-RC1"` |  |
...
| backend.services.image.servicesservicetag | string | `"v1.3.0-RC1"` |  |
...
| backend.provisioningmigrations.image.provisioningmigrationstag | string | `"v1.3.0-RC1"` |  |
...
| backend.checklistworker.image.checklistworkertag | string | `"v1.3.0-RC1"` |  |
