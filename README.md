...
![Version: 1.6.0-RC8](https://img.shields.io/badge/Version-1.6.0--RC8-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.6.0-RC8](https://img.shields.io/badge/AppVersion-1.6.0--RC8-informational?style=flat-square) ![Tag](https://img.shields.io/static/v1?label=&message=LeadingRepository&color=green&style=flat)

This helm chart installs the Catena-X Portal application which consists of

* [portal-frontend (v1.6.0-RC8)](https://github.com/eclipse-tractusx/portal-frontend/tree/v1.6.0-RC8),
* [portal-frontend-registration (v1.5.0-RC5)](https://github.com/eclipse-tractusx/portal-frontend-registration/tree/v1.5.0-RC5),
* [portal-assets (v1.6.0-RC6)](https://github.com/eclipse-tractusx/portal-assets/tree/v1.6.0-RC6) and
* [portal-backend (v1.6.0-RC8)](https://github.com/eclipse-tractusx/portal-backend/tree/v1.6.0-RC8).

The Catena-X Portal is designed to work with the [Catena-X IAM](https://github.com/eclipse-tractusx/portal-iam).
This version is compatible with the 1.2.0-RC2 version of the IAM instances:
* [Central Keycloak Instance](https://github.com/eclipse-tractusx/portal-iam/blob/centralidp-1.2.0-RC2/charts/centralidp/README.md)
* [Shared Keycloak Instance](https://github.com/eclipse-tractusx/portal-iam/blob/sharedidp-1.2.0-RC2/charts/sharedidp/README.md)

For information on how to upgrade from previous versions please refer to [Version Upgrade](https://github.com/eclipse-tractusx/portal-assets/tree/v1.6.0-RC6/developer/Technical%20Documentation/Version%20Upgrade/portal-upgrade-details.md).

For further information please refer to [Technical Documentation](https://github.com/eclipse-tractusx/portal-assets/tree/v1.6.0-RC6/developer/Technical%20Documentation).
...
| frontend.portal.image.portaltag | string | `"v1.6.0-RC8"` |  |
...
| frontend.registration.image.registrationtag | string | `"v1.5.0-RC5"` |  |
...
| frontend.assets.image.assetstag | string | `"v1.6.0-RC6"` |  |
...
| backend.registration.image.registrationservicetag | string | `"v1.6.0-RC8"` |  |
...
| backend.administration.image.administrationservicetag | string | `"v1.6.0-RC8"` |  |
...
| backend.appmarketplace.image.appmarketplaceservicetag | string | `"v1.6.0-RC8"` |  |
...
| backend.portalmigrations.image.portalmigrationstag | string | `"v1.6.0-RC8"` |  |
...
| backend.portalmaintenance.image.portalmaintenancetag | string | `"v1.6.0-RC8"` |  |
...
| backend.notification.image.notificationservicetag | string | `"v1.6.0-RC8"` |  |
...
| backend.services.image.servicesservicetag | string | `"v1.6.0-RC8"` |  |
...
| backend.provisioningmigrations.image.provisioningmigrationstag | string | `"v1.6.0-RC8"` |  |
...
| backend.processesworker.image.processesworkertag | string | `"v1.6.0-RC8"` |  |
