...
![Version: 2.5.0-RC2](https://img.shields.io/badge/Version-2.5.0--RC2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.5.0-RC2](https://img.shields.io/badge/AppVersion-2.5.0--RC2-informational?style=flat-square)

This helm chart installs the Portal application which consists of

* [portal-frontend (v2.4.0)](https://github.com/eclipse-tractusx/portal-frontend/tree/v2.4.0),
* [portal-frontend-registration (v2.2.0)](https://github.com/eclipse-tractusx/portal-frontend-registration/tree/v2.2.0),
* [portal-assets (v2.4.0)](https://github.com/eclipse-tractusx/portal-assets/tree/v2.4.0) and
* [portal-backend (v2.4.0)](https://github.com/eclipse-tractusx/portal-backend/tree/v2.4.0).

The Portal is designed to work with the [IAM](https://github.com/eclipse-tractusx/portal-iam).
This version is compatible with the 4.1.0 version of the IAM instances:
* [Central Keycloak Instance](https://github.com/eclipse-tractusx/portal-iam/blob/centralidp-4.1.0/charts/centralidp/README.md)
* [Shared Keycloak Instance](https://github.com/eclipse-tractusx/portal-iam/blob/sharedidp-4.1.0/charts/sharedidp/README.md)

For information on how to upgrade from previous versions please refer to [Version Upgrade](https://github.com/eclipse-tractusx/portal-assets/tree/v2.4.0/docs/admin/Version%20Upgrade/portal-upgrade-details.md).

For further information please refer to [Technical Documentation](https://github.com/eclipse-tractusx/portal-assets/tree/v2.4.0/docs/admin).

For information about the initial wallet insert for the Operator, please refer to [initial operator wallet setup](https://github.com/eclipse-tractusx/portal-assets/blob/v2.4.0/docs/admin/Operator%20Wallet%20Setup/Initial%20Setup.md).
...
| clearinghouse.default | object | `{"apiPath":"/api/v2/validation","baseAddress":"https://default.example.org","clearinghouseConnectDisabled":false,"clientId":"clearinghouse-client-id-default","clientSecret":"","countryAlpha2Code":"default","grantType":"client_credentials","scope":"openid","tokenAddress":"https://default.example.org/realms/example/protocol/openid-connect/token"}` | Provide the configuration of the default clearing house |
...
| clearinghouse.default.clearinghouseConnectDisabled | bool | `false` | if set to true the self description document creation will be skipped for company registrations as well as connector registrations |
...
| dimWrapper | object | `{"apiPath":"/api/dim","baseAddress":"https://dim.example.org","tokenAddress":"https://keycloak.example.org/realms/example/protocol/openid-connect/token"}` | Provide the configuration of the dim wrapper address |
...
| frontend.portal.image.portaltag | string | `"v2.5.0-RC2"` |  |
...
| frontend.registration.image.registrationtag | string | `"v2.2.1-RC1"` |  |
...
| frontend.assets.image.assetstag | string | `"v2.5.0"` |  |
...
| backend.registration.image.registrationservicetag | string | `"v2.5.0-RC2"` |  |
...
| backend.administration.image.administrationservicetag | string | `"v2.5.0-RC2"` |  |
...
| backend.appmarketplace.image.appmarketplaceservicetag | string | `"v2.5.0-RC2"` |  |
...
| backend.portalmigrations.image.portalmigrationstag | string | `"v2.5.0-RC2"` |  |
...
| backend.portalmaintenance.image.portalmaintenancetag | string | `"v2.5.0-RC2"` |  |
...
| backend.notification.image.notificationservicetag | string | `"v2.5.0-RC2"` |  |
...
| backend.services.image.servicesservicetag | string | `"v2.5.0-RC2"` |  |
...
| backend.provisioningmigrations.image.provisioningmigrationstag | string | `"v2.5.0-RC2"` |  |
...
| backend.processesworker.image.processesworkertag | string | `"v2.5.0-RC2"` |  |
