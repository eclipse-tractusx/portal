...
![Version: 2.0.0-RC9](https://img.shields.io/badge/Version-2.0.0--RC9-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.0.0-RC9](https://img.shields.io/badge/AppVersion-2.0.0--RC9-informational?style=flat-square)

This helm chart installs the Catena-X Portal application which consists of

* [portal-frontend (v2.0.0-RC8)](https://github.com/eclipse-tractusx/portal-frontend/tree/v2.0.0-RC8),
* [portal-frontend-registration (v2.0.0-RC2)](https://github.com/eclipse-tractusx/portal-frontend-registration/tree/v2.0.0-RC2),
* [portal-assets (v2.0.0-RC2)](https://github.com/eclipse-tractusx/portal-assets/tree/v2.0.0-RC2) and
* [portal-backend (v2.0.0-RC9)](https://github.com/eclipse-tractusx/portal-backend/tree/v2.0.0-RC9).

The Catena-X Portal is designed to work with the [Catena-X IAM](https://github.com/eclipse-tractusx/portal-iam).
This version is compatible with the 3.0.0-rc.3 version of the IAM instances:
* [Central Keycloak Instance](https://github.com/eclipse-tractusx/portal-iam/blob/centralidp-3.0.0-rc.3/charts/centralidp/README.md)
* [Shared Keycloak Instance](https://github.com/eclipse-tractusx/portal-iam/blob/sharedidp-3.0.0-rc.3/charts/sharedidp/README.md)

For information on how to upgrade from previous versions please refer to [Version Upgrade](https://github.com/eclipse-tractusx/portal-assets/tree/v2.0.0-RC2/docs/developer/Technical%20Documentation/Version%20Upgrade/portal-upgrade-details.md).

For further information please refer to [Technical Documentation](https://github.com/eclipse-tractusx/portal-assets/tree/v2.0.0-RC2/docs/developer/Technical%20Documentation).
...
| frontend.portal.image.portaltag | string | `"v2.0.0-RC8"` |  |
...
| frontend.registration.image.registrationtag | string | `"v2.0.0-RC2"` |  |
...
| frontend.assets.image.assetstag | string | `"v2.0.0-RC2"` |  |
...
| backend.registration.image.registrationservicetag | string | `"v2.0.0-RC9"` |  |
...
| backend.administration.image.administrationservicetag | string | `"v2.0.0-RC9"` |  |
...
| backend.appmarketplace.image.appmarketplaceservicetag | string | `"v2.0.0-RC9"` |  |
...
| backend.portalmigrations.image.portalmigrationstag | string | `"v2.0.0-RC9"` |  |
...
| backend.portalmaintenance.image.portalmaintenancetag | string | `"v2.0.0-RC9"` |  |
...
| backend.notification.image.notificationservicetag | string | `"v2.0.0-RC9"` |  |
...
| backend.services.image.servicesservicetag | string | `"v2.0.0-RC9"` |  |
...
| backend.provisioningmigrations.image.provisioningmigrationstag | string | `"v2.0.0-RC9"` |  |
...
| backend.processesworker.image.processesworkertag | string | `"v2.0.0-RC9"` |  |
