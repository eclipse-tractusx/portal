...
![Version: 2.6.0-RC1](https://img.shields.io/badge/Version-2.6.0--RC1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.6.0-RC1](https://img.shields.io/badge/AppVersion-2.6.0--RC1-informational?style=flat-square)
...
| frontend.portal.image.portaltag | string | `"v2.6.0-RC1"` |  |
...
| frontend.registration.image.registrationtag | string | `"v2.2.0-RC1"` |  |
...
| backend.registration.image.registrationservicetag | string | `"v2.6.0-RC1"` |  |
...
| backend.administration.image.administrationservicetag | string | `"v2.6.0-RC1"` |  |
...
| backend.appmarketplace.image.appmarketplaceservicetag | string | `"v2.6.0-RC1"` |  |
...
| backend.portalmigrations.image.portalmigrationstag | string | `"v2.6.0-RC1"` |  |
...
| backend.portalmaintenance.image.portalmaintenancetag | string | `"v2.6.0-RC1"` |  |
...
| backend.notification.image.notificationservicetag | string | `"v2.6.0-RC1"` |  |
...
| backend.services.image.servicesservicetag | string | `"v2.6.0-RC1"` |  |
...
| backend.provisioningmigrations.image.provisioningmigrationstag | string | `"v2.6.0-RC1"` |  |
...
| backend.processesworker.image.processesworkertag | string | `"v2.6.0-RC1"` |  |
