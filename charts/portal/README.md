...
![Version: 2.2.0-RC4](https://img.shields.io/badge/Version-2.2.0--RC4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.2.0-RC4](https://img.shields.io/badge/AppVersion-2.2.0--RC4-informational?style=flat-square)

This helm chart installs the Portal application which consists of

* [portal-frontend (v2.2.0-RC3)](https://github.com/eclipse-tractusx/portal-frontend/tree/v2.2.0-RC3),
...
* [portal-backend (v2.2.0-RC4)](https://github.com/eclipse-tractusx/portal-backend/tree/v2.2.0-RC4).
...
| frontend.portal.image.portaltag | string | `"v2.2.0-RC3"` |  |
...
| backend.registration.image.registrationservicetag | string | `"v2.2.0-RC4"` |  |
...
| backend.administration.image.administrationservicetag | string | `"v2.2.0-RC4"` |  |
...
| backend.appmarketplace.image.appmarketplaceservicetag | string | `"v2.2.0-RC4"` |  |
...
| backend.portalmigrations.image.portalmigrationstag | string | `"v2.2.0-RC4"` |  |
...
| backend.portalmaintenance.image.portalmaintenancetag | string | `"v2.2.0-RC4"` |  |
...
| backend.notification.image.notificationservicetag | string | `"v2.2.0-RC4"` |  |
...
| backend.services.image.servicesservicetag | string | `"v2.2.0-RC4"` |  |
...
| backend.provisioningmigrations.image.provisioningmigrationstag | string | `"v2.2.0-RC4"` |  |
...
| backend.processesworker.image.processesworkertag | string | `"v2.2.0-RC4"` |  |
