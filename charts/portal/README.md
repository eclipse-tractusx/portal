...
* [portal-frontend (v2.1.0-RC3)](https://github.com/eclipse-tractusx/portal-frontend/tree/v2.1.0-RC3),
* [portal-frontend-registration (v2.0.1-RC2)](https://github.com/eclipse-tractusx/portal-frontend-registration/tree/v2.0.1-RC2),
* [portal-assets (v2.1.0-RC1)](https://github.com/eclipse-tractusx/portal-assets/tree/v2.1.0-RC1 and
* [portal-backend (v2.1.0-RC2)](https://github.com/eclipse-tractusx/portal-backend/tree/v2.1.0-RC2).
...
For information on how to upgrade from previous versions please refer to [Version Upgrade](https://github.com/eclipse-tractusx/portal-assets/tree/v2.1.0-RC1/docs/developer/Technical%20Documentation/Version%20Upgrade/portal-upgrade-details.md).

For further information please refer to [Technical Documentation](https://github.com/eclipse-tractusx/portal-assets/tree/v2.1.0-RC1/docs/developer/Technical%20Documentation).

For information about the initial wallet insert for the Operator, please refer to [initial operator wallet setup](https://github.com/eclipse-tractusx/portal-assets/blob/v2.1.0-RC1/docs/developer/Technical%20Documentation/Operator%20Wallet%20Setup/Initial%20Setup.md).
...
| frontend.portal.image.portaltag | string | `"v2.1.0-RC3"` |  |
...
| frontend.assets.image.assetstag | string | `"v2.1.0-RC1"` |  |
...
| backend.registration.image.registrationservicetag | string | `"v2.1.0-RC2"` |  |
...
| backend.administration.image.administrationservicetag | string | `"v2.1.0-RC2"` |  |
...
| backend.appmarketplace.image.appmarketplaceservicetag | string | `"v2.1.0-RC2"` |  |
...
| backend.portalmigrations.image.portalmigrationstag | string | `"v2.1.0-RC2"` |  |
...
| backend.portalmaintenance.image.portalmaintenancetag | string | `"v2.1.0-RC2"` |  |
...
| backend.notification.image.notificationservicetag | string | `"v2.1.0-RC2"` |  |
...
| backend.services.image.servicesservicetag | string | `"v2.1.0-RC2"` |  |
...
| backend.provisioningmigrations.image.provisioningmigrationstag | string | `"v2.1.0-RC2"` |  |
...
| backend.processesworker.image.processesworkertag | string | `"v2.1.0-RC2"` |  |
