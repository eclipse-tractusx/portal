...
![Version: 2.0.0-RC5](https://img.shields.io/badge/Version-2.0.0--RC5-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.0.0-RC5](https://img.shields.io/badge/AppVersion-2.0.0--RC5-informational?style=flat-square)
...
For further information please refer to [Technical Documentation](https://github.com/eclipse-tractusx/portal-assets/tree/v1.8.0/docs/developer/Technical%20Documentation).
...
| bpnDidResolverAddress | string | `"http://bpn-did-resolution-service-bdrs-server:8081"` | Provide BPN DID Resolver Service base address |
...
| frontend.portal.image.portaltag | string | `"v2.0.0-RC4"` |  |
...
| backend.registration.image.registrationservicetag | string | `"v2.0.0-RC5"` |  |
...
| backend.administration.image.administrationservicetag | string | `"v2.0.0-RC5"` |  |
...
| backend.appmarketplace.image.appmarketplaceservicetag | string | `"v2.0.0-RC5"` |  |
...
| backend.portalmigrations.image.portalmigrationstag | string | `"v2.0.0-RC5"` |  |
...
| backend.portalmaintenance.image.portalmaintenancetag | string | `"v2.0.0-RC5"` |  |
...
| backend.notification.image.notificationservicetag | string | `"v2.0.0-RC5"` |  |
...
| backend.services.image.servicesservicetag | string | `"v2.0.0-RC5"` |  |
...
| backend.provisioningmigrations.image.provisioningmigrationstag | string | `"v2.0.0-RC5"` |  |
...
| backend.processesworker.image.processesworkertag | string | `"v2.0.0-RC5"` |  |
